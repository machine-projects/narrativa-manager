...
//remover
      videoCadastrado.title_presentation= translateToPortuguese(channel.targetLanguage , video.title),
      result.update.push(videoCadastrado);
    } else {
      const newVideo = {
        ...video,
        channel,
        title_presentation: translateToPortuguese(video.targetLanguage , video.title),
