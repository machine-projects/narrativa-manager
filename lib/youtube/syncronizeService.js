...
//remover
      //videoCadastrado.title_presentation= await translateToPortuguese(channel.targetLanguage , video.title),
      result.update.push(videoCadastrado);
    } else {
      const newVideo = {
        ...video,
        channel,
        title_presentation: await translateToPortuguese(video.targetLanguage , video.title),
